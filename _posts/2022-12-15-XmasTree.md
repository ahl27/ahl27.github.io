...
We can then remove all the brackets, spaces, and newlines to get a final character count of just 176 characters.
{% highlight c %}
int main(){int i=-1,j,v,k;for(;i++<16;puts(""))for(j=-
