...
All the code for this can be found on the [GitHub repo](https://github.com/ahl27/machineRy) for this project (update: see [here](https://github.com/ahl27/SynExtend/tree/master/src/ExoLabel) for the latest version!).
